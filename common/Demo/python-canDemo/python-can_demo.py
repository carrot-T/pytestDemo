...
hwhandle = can.Bus(interface="libtosun", config=configs, ignore_config=True, is_recv_error=True, is_include_tx=True, hwserial=b"")
...
input('jjl：')
hwhandle.stop_all_periodic_tasks()
hwhandle.shutdown()